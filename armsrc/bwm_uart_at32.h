...
// Blocking write of one whole frame. After ~3 s without link traffic it first
// sends a wake preamble for the ESP's light sleep and waits ~10 ms (see the
// BWM_ESP_* defines in bwm_uart_at32.c).
