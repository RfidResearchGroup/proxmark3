...
#ifndef USBD_SUPPORT_WINUSB // Fix 'error: "USBD_SUPPORT_WINUSB" is not defined, evaluates to 0'
...
/* use otgfs2 */
#define OTG_USB_ID                         2 // USB2 仅UFP 只从机 默认5v输入 无输出
...
// void usb_delay_us(uint32_t us); unused
