...
/*
 * Do not import any at32f435_437_xxx header file in this file.
 * This will cause developers who only want to include the at32f435_437 header file to get a bunch of unnecessary contents,
 * which will lead to possible conflicts of variable/function names!!!
 * ---
 * So all the module enable definitions below have been moved to CMakeLists.txt,
 * and all the driver header files of at32f435_437_xxx are included only when they are used.
 * ---
 * If you do not do this, the 'usart_init ' function in the usart driver of at32 will cause the conflicting types error by pm3's usart module .
 */
