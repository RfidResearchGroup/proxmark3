...
typedef enum EM4X70_AUTHBRANCH_PHASE {
    ...
    EM4X70_AUTHBRANCH_PHASE1_VERIFY_STARTING_VALUES = (1 <<  1), // 0x00000002       2
    EM4X70_AUTHBRANCH_PHASE2_WRITE_BRANCHED_KEY     = (1 <<  2), // 0x00000004       4
    EM4X70_AUTHBRANCH_PHASE3_BRUTE_FORCE            = (1 << 16), // 0x00010000   65536
...
// ALL VALUES IN THIS STRUCTURE ARE STORED INTERNALL AS BIG-ENDIAN VALUES (for consistency)
