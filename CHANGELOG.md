...
## [1.7.0 iceman fork] [2017-03-07]
 ...
 - small changes to lf psk and fsk demods to improve results when the trace begins with noise or the chip isn't broadcasting yet (@marshmellow42)
...
## [1.6.9 iceman fork] [2017-02-06]
 ...
 - `hf emv` - Added Peter Fillmore's EMV branch now compiles on iceman fork.  See seperate issue. (@iceman1001)
...
## [1.6.7 iceman fork] [2017-01-05]
 ...
 - `hf mf mifare` fixing the zero parity path, which doesn't got called. (@iceman1001)
 ...
 - Started to add Peter Fillmore's  EMV fork into Iceman fork. ref: https://github.com/peterfillmore/proxmark3  (@peterfillmore,  @iceman1001)
