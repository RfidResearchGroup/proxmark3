...
// Resolve an advertised device name to its LE address via LE discovery (BlueZ mgmt API).
...
// Needs CAP_NET_RAW+CAP_NET_ADMIN (mgmt discovery), i.e. more privilege than connect.
