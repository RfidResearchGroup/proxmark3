...
const static vocabulary_t vocabulary[] = {
    ...
    { 0, "hf fmcos select" },
    { 0, "hf fmcos erase" },
    { 0, "hf fmcos createdir" },
    { 0, "hf fmcos createfile" },
    { 0, "hf fmcos createkeyfile" },
    { 0, "hf fmcos readbinary" },
    { 0, "hf fmcos readrecord" },
    { 0, "hf fmcos writebinary" },
    { 0, "hf fmcos writerecord" },
    { 0, "hf fmcos append" },
    { 0, "hf fmcos authexternal" },
    { 0, "hf fmcos authinternal" },
    { 0, "hf fmcos key" },
    { 0, "hf fmcos pinverify" },
    { 0, "hf fmcos pinchange" },
    { 0, "hf fmcos pinreset" },
    { 0, "hf fmcos pinunblock" },
    { 0, "hf fmcos balance" },
    { 0, "hf fmcos credit" },
    { 0, "hf fmcos purchase" },
    { 0, "hf fmcos overdraft" },
    { 0, "hf fmcos history" },
    { 0, "hf fmcos block" },
    { 0, "hf fmcos unblock" },
    { 0, "hf fmcos tidsetcard" },
    { 0, "hf fmcos tidsetuid" },
    { 0, "hf fmcos tidsetauth" },
    { 0, "hf fmcos tiderase" },
    { 0, "hf fmcos tidprovision" },
    { 0, "hf fmcos tidcreatedf" },
    { 0, "hf fmcos tidcreatebin" },
    { 0, "hf fmcos tidcreaterec" },
    { 1, "hf fudan help" },
    { 0, "hf fudan reader" },
    { 0, "hf fudan dump" },
    { 0, "hf fudan rdbl" },
    ...
    { 0, "hf mf gdmgetblk" },
    { 0, "hf mf gdmsetblk" },
    { 0, "hf mf gdmgethidblk" },
    { 0, "hf mf gdmsethidblk" },
    { 0, "hf mf gdmsetuid" },
    { 0, "hf mf gdmwipe" },
    { 0, "hf mf gdmsetsig" },
    { 0, "hf mf ndefformat" },
