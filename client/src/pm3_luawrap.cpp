...
static int _wrap_pm3_console_async_wrapper(lua_State* L) {
  int SWIG_arg = 0;
  pm3 *arg1 = (pm3 *) 0 ;
  char *arg2 = (char *) 0 ;
  ...
  SWIG_check_num_args("pm3::console_async_wrapper",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("pm3::console_async_wrapper",1,"pm3 *");
  if(!SWIG_lua_isnilstring(L,2)) SWIG_fail_arg("pm3::console_async_wrapper",2,"char *");
  if(!SWIG_isptrtype(L,3)) SWIG_fail_arg("pm3::console_async_wrapper",3,"ConsoleHandler *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_pm3,0))){
    SWIG_fail_ptr("pm3_console_async_wrapper",1,SWIGTYPE_p_pm3);
  }
  
  arg2 = (char *)lua_tostring(L, 2);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_ConsoleHandler,0))){
    SWIG_fail_ptr("pm3_console_async_wrapper",3,SWIGTYPE_p_ConsoleHandler);
  }
...
static swig_lua_method swig_pm3_methods[]= {
    ...
    { "console_async_wrapper", _wrap_pm3_console_async_wrapper},
    {0,0}
};
...
static int _wrap_ConsoleHandler_handle_output(lua_State* L) {
  int SWIG_arg = 0;
  ConsoleHandler *arg1 = (ConsoleHandler *) 0 ;
  char *arg2 = (char *) 0 ;
  int result;
  
  SWIG_check_num_args("ConsoleHandler::handle_output",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("ConsoleHandler::handle_output",1,"ConsoleHandler *");
  if(!SWIG_lua_isnilstring(L,2)) SWIG_fail_arg("ConsoleHandler::handle_output",2,"char *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ConsoleHandler,0))){
    SWIG_fail_ptr("ConsoleHandler_handle_output",1,SWIGTYPE_p_ConsoleHandler);
  }
...
static void swig_delete_ConsoleHandler(void *obj) {
ConsoleHandler *arg1 = (ConsoleHandler *) obj;
delete arg1;
}
static swig_lua_attribute swig_ConsoleHandler_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_ConsoleHandler_methods[]= {
    { "handle_output", _wrap_ConsoleHandler_handle_output},
    {0,0}
};
static swig_lua_method swig_ConsoleHandler_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_ConsoleHandler_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_ConsoleHandler_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_ConsoleHandler_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_ConsoleHandler_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_ConsoleHandler_Sf_SwigStatic = {
    "ConsoleHandler",
    swig_ConsoleHandler_Sf_SwigStatic_methods,
    swig_ConsoleHandler_Sf_SwigStatic_attributes,
    swig_ConsoleHandler_Sf_SwigStatic_constants,
    swig_ConsoleHandler_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_ConsoleHandler_bases[] = {0};
static const char *swig_ConsoleHandler_base_names[] = {0};
static swig_lua_class _wrap_class_ConsoleHandler = { "ConsoleHandler", "ConsoleHandler", &SWIGTYPE_p_ConsoleHandler,0, swig_delete_ConsoleHandler, swig_ConsoleHandler_methods, swig_ConsoleHandler_attributes, &swig_ConsoleHandler_Sf_SwigStatic, swig_ConsoleHandler_meta, swig_ConsoleHandler_bases, swig_ConsoleHandler_base_names };
...
static swig_type_info _swigt__p_ConsoleHandler = {"_p_ConsoleHandler", "ConsoleHandler *", 0, 0, (void*)&_wrap_class_ConsoleHandler, 0};
