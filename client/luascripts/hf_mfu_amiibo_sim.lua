...
example = [[
    1. script run hf_mf_amiibo_sim
    2. script run hf_mf_amiibo_sim -f myfile
]]
usage = [[
script run hf_mf_amiibo_sim [-h] [-f <filename>]
]]
arguments = [[
    -h             : this help
...
local function main(args)
    ...
    print('game: '..ansicolors.green..amiiboDb.game_series[("0x%s"):format(amiibo_game)]..ansicolors.reset)
    print('character: '..ansicolors.green..amiiboDb.amiibos[("0x%s"):format(amiibo_info)].name..ansicolors.reset)
    print('type: '..ansicolors.green..amiiboDb.types[("0x%s"):format(amiibo_type)]..ansicolors.reset)
    print('series: '..ansicolors.green..amiiboDb.amiibo_series[("0x%s"):format(amiibo_series)]..ansicolors.reset)
